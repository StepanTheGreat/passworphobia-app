<script lang="ts">
    ...
    function moveState() {
        if (to == "settings") {
            appState.set(AppState.Settings);
        } else if (to == "home") {
